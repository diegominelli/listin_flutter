...
class MyColors {
  ...
  static const MaterialColor earthyBrown =
      MaterialColor(_earthyBrownPrimaryValue, <int, Color>{
        50: Color(0xFFF1E6DE),
        100: Color(0xFFE0C6B7),
        200: Color(0xFFCEA28C),
        300: Color(0xFFBC7D60),
        400: Color(0xFFAD623E),
        500: Color(_earthyBrownPrimaryValue),
        600: Color(0xFF713C10),
        700: Color(0xFF5F320D),
        800: Color(0xFF4D280A),
        900: Color(0xFF331A06),
      });
  static const int _earthyBrownPrimaryValue = 0xFF7F4311;

  static const MaterialColor cornYellow =
      MaterialColor(_cornYellowPrimaryValue, <int, Color>{
        50: Color(0xFFFFFEEC),
        100: Color(0xFFFFFCD0),
        200: Color(0xFFFFF9B2),
        300: Color(0xFFFFF695),
        400: Color(0xFFFFF47F),
        500: Color(_cornYellowPrimaryValue),
        600: Color(0xFFE6E681),
        700: Color(0xFFCCCC70),
        800: Color(0xFFB3B35E),
        900: Color(0xFF8F8F45),
      });
  static const int _cornYellowPrimaryValue = 0xFFFFFF96;
